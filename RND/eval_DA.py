...
# Load trained policy
checkpoint_path = 'checkpoints_DA2/dagger_iter_60.pt'  # Or choose a specific iteration checkpoint
...
policy.load_state_dict(torch.load(checkpoint_path, map_location=device)['policy_state_dict'])
