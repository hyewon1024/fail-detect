...
class RNDDAgger:
    ...
    def evaluate_policy(self, env, num_episodes_target: int = 20):
        ...
        while episode_count < num_episodes_target:
            # Update history
            self._update_history(obs)
        ...
        print(f"Evaluation complete: Success Rate = {success_rate:.4f}, Episodes = {episode_count}")

        return success_rate, episode_count
    
    def collect_data(self, env, num_steps: int, beta=None, alpha_=None, tau: float = 0.1):
